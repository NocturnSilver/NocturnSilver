<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=600&size=30&duration=6000&pause=1000&color=18F71D&background=05062A&center=true&vCenter=true&width=435&lines=Welcome+to+my+github+page;You+are+welcome+to+browse;If+you+find+something+interesting;you+can+check+them+out;.....;Since+you're+still+staring+at+it+;I+might+as+well+just+try+to+entertain;...;If+a+tree+is+unbalanced+and+long;it's+probably+a+bamboo;but+if+it's+balanced+and+short;it's+probably+a+bonsai;...;My+niece+calls+me+ankle;I+call+her+my+knees;..." alt="Typing SVG" /></a>
